...
namespace Homework_01
{
    ...
    class Repository
    {
        private static int UndeleteCount = 30;
        /// <summary>
        /// База данных имён
        /// </summary>
        ...
        public void DeleteWorkeUntillThirty()
        {
            int count = this.Workers.Count;
            if(count < 30)
                Console.WriteLine("В БД меньше 30 сотрудников, удаление невозможно!");
            else
            {
                this.Workers.RemoveRange(UndeleteCount, count - UndeleteCount);
                Console.WriteLine("Было удалено {0} сотрудников!", count - UndeleteCount);
            }
